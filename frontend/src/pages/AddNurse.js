...
import { userAPI, nurseAPI } from "../api/api";
...
const AddNurse = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Create both User and Nurse in one atomic transaction
      ...
      if (err.username) {
        ...
        setError("Failed to add nurse. Please try again.");
      }
    } finally {
      setLoading(false);
    }
      ...
      <div style={styles.layout}>
        ...
        <main style={styles.content}>
          <div style={styles.header}>
            <h1 style={styles.pageTitle}>Add New Nurse</h1>
            <button
          ...
          <div style={styles.formContainer}>
            <form onSubmit={handleSubmit} style={styles.form}>
              ...
              <h3 style={styles.sectionTitle}>Nurse Information</h3>
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? "Adding Nurse..." : "Add Nurse"}
              </button>
            </form>
          </div>
        </main>
